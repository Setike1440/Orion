          ...
          <div className="sticky top-28 space-y-6">
            <div className="bg-[#121318] border border-[#1f212a] p-4 rounded-2xl shadow-sm">
              <div className="relative aspect-[460/215] rounded-xl overflow-hidden mb-5">
                ...
                />
                <div className="absolute top-2.5 left-2.5 bg-[#102131] border border-[#2a475e] text-[#66c0f4] backdrop-blur-md text-[10px] font-semibold px-2.5 py-1 rounded-md flex items-center gap-1.5 shadow-sm">
