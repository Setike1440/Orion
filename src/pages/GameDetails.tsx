...
import { ShieldCheck, Download, Lock, Key, Copy, CheckCircle2, ArrowLeft, Heart, MonitorCheck } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-8 flex flex-col">
          ...
          <div className="mt-6 border-t border-[#1f212a] pt-8">
            ...
            {user ? (
              <div className="bg-[#121318] border border-[#1f212a] rounded-2xl p-6 relative overflow-hidden shadow-sm">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#268FFF] opacity-5 blur-[80px] rounded-full"></div>
                
                <p className="text-xs sm:text-sm text-gray-400 mb-6 max-w-xl leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-[#0a0b0e] border border-[#1f212a] rounded-xl p-4">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <span className="text-white font-mono text-base">{game.steam_username}</span>
                      <button 
                        onClick={() => copyToClipboard(game.steam_username, 'user')}
                  ...
                  <div className="bg-[#0a0b0e] border border-[#1f212a] rounded-xl p-4">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <span className="text-white font-mono text-base">{game.steam_password}</span>
                      <button 
                        onClick={() => copyToClipboard(game.steam_password, 'pass')}
                        className="text-gray-400 hover:text-[#268FFF] transition-colors p-2 bg-[#121318] border border-[#1f212a] rounded-lg cursor-pointer"
                        title={t('copy_pass')}
                      >
                ...
                <div className="mt-5 bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex gap-3">
